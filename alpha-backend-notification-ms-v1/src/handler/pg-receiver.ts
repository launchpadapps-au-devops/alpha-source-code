...
import { EmailHandler } from 'src/email/email.handler';

@Injectable()
export class PGNotificationListner implements OnModuleInit, OnApplicationShutdown {
    ...
    constructor(
        ...
        console.log('PGNotificationListner');
     }
    ...
    async onApplicationShutdown(signal?: string) {
        if (this.client) {
            ...
            Logger.log(`PGNotificationListener shutdown due to ${signal}`);
        }
    }
}
